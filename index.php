		...
		<section class= "container-fluid cont">
		    <section class= "row row1">
		    	...
		    	<div id= "roomNav" class= "col-md-2">
			    	...
			    	<div class= "row">
			    		<div class= "col-md-12 actions">
			    			<button class= "interact" id= "targetbutton">Target</button>
			    			<button class= "interact" id= "attackbutton" disabled>Attack</button>
			    			<button class= "interact" id= "lookbutton">Look</button>
			    			<button class= "interact" id= "openbutton" disabled>Open</button>
			    			<button class= "interact" id= "takebutton" disabled>Take</button>
			    		</div>
			    	</div>
		    	</div>
		    	<div id= "mapback" class= "col-md-3">
		  	...
		  	<section class= "row row2">
		  		...
		  		<div class= "col-md-3 herostats">
		  			<h2>Equipment</h2>
		  			<p id= "weaponline"><button class= "interact" id= "weaponbutton">Weapon</button><button class= "interact" id= "healbutton">Medpack</button></p>
		  			<p id= "armor"></p>
		  		</div>
